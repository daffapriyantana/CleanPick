...
class _CreateOrderPageState extends State<CreateOrderPage> {
  final _addressController = TextEditingController(text: 'Jl. Melati No. 12, RT 05/RW 03, Jakarta Selatan');
        ...
        listener: (context, state) {
          if (state is OrderCreated) {
            Navigator.of(context).pushReplacement(
              MaterialPageRoute(builder: (_) => OrderDetailPage(orderId: state.order.id)),
            );
            ...
            child: Column(
              ...
              children: [
                ...
                TextField(
                  ...
                  maxLines: 2,
                  decoration: const InputDecoration(hintText: 'Masukkan alamat pengambilan'),
                ...
                TextField(
                  ...
                  decoration: const InputDecoration(hintText: 'contoh: 10', suffixText: 'kg'),
                  onChanged: (_) => _recalculate(),
                ),
                const SizedBox(height: 20),
                  ...
                  children: VehicleType.values.map((v) {
                    ...
                    return Card(
                      ...
                      child: RadioListTile<VehicleType>(
                        ...
                        title: Text(v.label),
                        subtitle: Text('Kapasitas hingga ${v.maxCapacityKg >= 100000 ? '1000+' : v.maxCapacityKg.toStringAsFixed(0)} kg'),
                        onChanged: (val) {
                ...
                InkWell(
                  ...
                  child: InputDecorator(
                    ...
                    child: Text(
                      _pickupDate == null ? 'Pilih tanggal' : DateFormat('dd MMMM yyyy', 'id_ID').format(_pickupDate!),
                    ),
                  ),
                ),
                const SizedBox(height: 20),
                ...
                TextField(
                  ...
                  decoration: const InputDecoration(hintText: 'Contoh: Sampah ada di depan pagar...'),
                ),
                const SizedBox(height: 20),
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          Text(value, style: style.copyWith(color: bold ? AppColors.primary : AppColors.textPrimary)),
        ],
      ),
    );
  }
